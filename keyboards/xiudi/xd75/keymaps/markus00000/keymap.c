...
KC_CAPS,  MO(_FN3), KC_LGUI,  KC_LALT,  MO(_FN2), MO(_FN1), KC_TAB,   KC_DEL,   KC_ENTER, KC_SPACE, KC_BSPC,  KC_RALT,  KC_LGUI,  MO(_FN3), KC_INS
),
...
KC_LSFT,  DE_A,     DE_S,     DE_D,     DE_F,     DE_G,     KC_PGUP,  KC_UP,    KC_PGDN,  DE_H,     DE_J,     DE_K,     DE_L,     DE_ODIA,  KC_RSFT,
KC_LCTL,  DE_Z,     DE_X,     DE_C,     DE_V,     DE_B,     KC_LEFT,  KC_DOWN,  KC_RIGHT, DE_N,     DE_M,     DE_COMM,  DE_DOT,   DE_MINS,  KC_RCTL,
MO(_FN2), MO(_FN3), KC_LGUI,  KC_LALT,  KC_SPACE, MO(_FN1), KC_TAB,   KC_DEL,   KC_ENTER, KC_SPACE, KC_BSPC,  KC_RALT,  KC_LGUI,  MO(_FN3), KC_INS
),
...
___xx___, ___xx___, ___xx___, ___xx___, DE_PERC,  DE_LPRN,  DE_RPRN,  KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PSCR,  KC_SCRL,  KC_PAUSE, UC(L'ẞ'), UC(L'±'),
________, ___xx___, KC_VOLD,  KC_MUTE,  KC_VOLU,  KC_BSPC,  KC_P7,    KC_P8,    KC_P9,    KC_PPLS,  MS_WHLU,  MS_UP,    MS_WHLD,  UC(L'×'), UC(L'÷'),
________, KC_APP,   MS_ACL2,  MS_ACL1,  MS_ACL0,  KC_SPACE, KC_P4,    KC_P5,    KC_P6,    MS_WHLL,  MS_LEFT,  MS_DOWN,  MS_RGHT,  MS_WHLR,  ________,
________, ___xx___, KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_TAB,   KC_P1,    KC_P2,    KC_P3,    KC_PENT,  MS_BTN1,  MS_BTN2,  MS_BTN3,  UC(L'—'), ________,
MO(_FN2), ________, ________, ________, ________, KC_PENT,  KC_P0,    DE_DOT,   KC_PDOT,  MS_BTN1,  MS_BTN2,  MS_BTN3,  ________, ________, ________
),

/* FN3
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | F13    | F14    | F15    | F16    | F17    | F18    | Bri-   | NumLck | Bri+   | F19    | F20    | F21    | F22    | F23    | F24    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | QWERTZ | U LNX  |        |        | Power  | L TOGG | L MP   | L NEXT |        | Pg Up  | Up     | Pg Dn  |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | QWERTY | U WIN  | ›      | ‹      | Sleep  | L HUEU | L SATU | L VALU | Home   | Left   | Down   | Right  | End    |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | GAMING | U MAC  | »      | «      | Wake   | L HUED | L SATD | L VALD | NumSp  | ThinSp | NaNbSp | NbSp   | NbHyph |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        |        |        | Reset  |        |        |        |        |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
[_FN3] = LAYOUT_ortho_5x15(
KC_F13,   KC_F14,   KC_F15,   KC_F16,   KC_F17,   KC_F18,   KC_BRID,  KC_NUM,   KC_BRIU,  KC_F19,   KC_F20,   KC_F21,   KC_F22,   KC_F23,   KC_F24,
________, QWERTZ,   UC_LINX,  ___xx___, ___xx___, KC_PWR,   UG_TOGG,  RGB_M_P,  UG_NEXT,  ___xx___, KC_PGUP,  KC_UP,    KC_PGDN,  ___xx___, ___xx___,
________, QWERTY,   UC_WINC,  UC(L'›'), UC(L'‹'), KC_SLEP,  UG_HUEU,  UG_SATU,  UG_VALU,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_END,   ________,
________, GAMING,   UC_MAC,   UC(L'»'), UC(L'«'), KC_WAKE,  UG_HUED,  UG_SATD,  UG_VALD,  UC(L' '), UC(L' '), UC(L' '), UC(L' '), UC(L'‑'), ________,
